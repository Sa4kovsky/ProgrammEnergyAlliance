...
namespace Contracts
{
     class Money
    {
        ...
        public static string Str(int val)
        {
            ...
            if (0 == n) r.Append("0 ");
            if (n%1000 != 0)
                r.Append(Money.Str(n, true, "", "", ""));

            n /= 1000;

            r.Insert(0, Money.Str(n, false, "тысяча", "тысячи", "тысяч"));
            n /= 1000;

            r.Insert(0, Money.Str(n, true, "миллион", "миллиона", "миллионов"));
            n /= 1000;

            r.Insert(0, Money.Str(n, true, "миллиард", "миллиарда", "миллиардов"));
            n /= 1000;

            r.Insert(0, Money.Str(n, true, "триллион", "триллиона", "триллионов"));
            n /= 1000;

            r.Insert(0, Money.Str(n, true, "триллиард", "триллиарда", "триллиардов"));
